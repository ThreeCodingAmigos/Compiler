define('ace/mode/glossa', function(require, exports, module) {
    ...
    var glossaHighlightRules = function() {
        ...
        var keywords = (
            ...
            "|Επίλεξε|Περίπτωση|Περίπτωση αλλίως|Τέλος_επιλογών"+
            "|Όσο|επανάλαβε|Τέλος_επανάληψης"+
            "|Αρχή_επανάληψης|Μέχρις_ότου"+
            "|Για|από|μέχρι|με_βήμα|με|βήμα" +
            "|Εμφάνισε|Διάβασε"+
            "|Κάλεσε" +
            "|Ακέραιες|Πραγματικές|Λογικές|Χαρακτήρες"+
            "|Ακέραια|Πραγματική|Χαρακτήρας|Λογική"
    );
        ...
        var keywordMapper = this.createKeywordMapper({
            "keyword": keywords,
            "storage.type": "Αλγόριθμος|Αρχή|Τέλος|ΣΥΝΑΡΤΗΣΗ|ΔΙΑΔΙΚΑΣΙΑ|ΤΕΛΟΣ_ΣΥΝΑΡΤΗΣΗΣ|ΤΕΛΟΣ_ΔΙΑΔΙΚΑΣΙΑΣ",
            "constant.language": buildinConstants,
            "constant.language.boolean": "Αληθής|Ψευδής",
    ...
    //AYTO TO ARXEIO ΟΥΣΙΑΣΤΙΚΆ ΕΙΝΑΙ ΑΥΤΟ ΠΟΥ ΠΡΑΣΙΝΊΖΕΙ ΤΟΝ ΣΩΣΤΟ ΣΥΝΤΑΚΤΙΚΟ ΕΝΩ ΓΡΑΦΟΥΜΕ ΤΟ ΠΡΟΓΡΑΜΜΑ ΚΑΙ ΕΙΝΑΙ ΥΠΕΥΘΗΝΟ ΓΙΑ ΤΟ RECOMEND ΟΤΑΝ ΒΑΖΟΥΜΕ ΠΧ _